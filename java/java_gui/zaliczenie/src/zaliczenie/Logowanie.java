...
public class Logowanie extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {           
            ...
            Scanner scan = new Scanner (new File("C:\\Users\\Mateusz Stadnicki\\Desktop\\java\\java_zaliczenie\\zaliczenie\\pass.txt"));
            ...
            if(user.equals(login)&&pass.equals(pas)) {
                new NewJFrame().setVisible(true);                
                
                
                JOptionPane.showMessageDialog(null, "Dane wprowadzone poprawnie, możesz dodawać informacje");
                
                try (PrintWriter zapis = new PrintWriter("C:\\Users\\Mateusz Stadnicki\\Desktop\\java\\java_zaliczenie\\zaliczenie\\zadania_wykonane.txt")) {
                    zapis.println("Użytkownik: " + user + " WYKONAŁ następujące zlecenia: ");
                }
                
                
            }else
            { 
                JOptionPane.showMessageDialog(null, "BŁĘDNE dane, wprowadz ponownie");
            }
